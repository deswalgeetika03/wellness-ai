...
st.markdown(
    ...
    :root {
        ...
        --wellness-surface-soft: #f1f4f0;
        --wellness-text: #26332e;
        --wellness-muted: #65726c;
        --wellness-accent: #6f9184;
        --wellness-accent-soft: #e8f0ec;
        --wellness-border: #dfe6e2;
        --wellness-danger: #8a4d4d;
        --wellness-radius: 14px;
        --wellness-radius-sm: 10px;
    }

    /* =====================================================
       GLOBAL APP SURFACES
       Force a consistent light, calm canvas even when the
       browser/Streamlit environment is using a dark theme.
       ===================================================== */
    ...
    section[data-testid="stSidebar"] hr {
        border-color: var(--wellness-border) !important;
        margin: 0.9rem 0;
    }

    /* Make native sidebar controls light and readable. */
    section[data-testid="stSidebar"] button {
        background: transparent !important;
        color: var(--wellness-text) !important;
        border: 1px solid transparent !important;
        border-radius: var(--wellness-radius-sm) !important;
    ...
    /* New Chat gets a quiet filled surface. */
    ...
    div[data-testid="stPopoverBody"] {
        ...
        min-width: 190px;
        border-radius: var(--wellness-radius) !important;
    }
    ...
    /* Remove overly prominent default avatar backgrounds. */
    div[data-testid="stChatMessageAvatarIcon"] {
        background: transparent !important;
    }
    ...
    div[data-testid="stChatInput"] > div {
        ...
        border: 1px solid var(--wellness-border) !important;
        border-radius: var(--wellness-radius) !important;
        box-shadow: 0 4px 18px rgba(38, 51, 46, 0.06) !important;
    }
    ...
    /* =====================================================
       ...
       Keep safety/error states clear without making the
       entire normal interface alarming.
       ===================================================== */
